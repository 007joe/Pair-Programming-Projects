...
1. To install your database, use git bash to navigate to the database folder, then run the following command: `winpty sh create_db.sh`.  You will need to provide your postgres password several times when prompted.
